...
We suggest that every programmer will dictate in the most convenient way. Every one of us has a different way of describing things that the we wants to say. it is the same with code dictation.
