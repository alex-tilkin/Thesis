...
\autoref{tab14} represents the command of the Modification Layer.  This layer Handles all modification commands that the user dictates.
...
\autoref{tab15} represents the command of the Selection Layer.  This layer Handles all selection commands that the user dictates.
...
\autoref{tab16} represents the command of the Deletion Layer.  This layer Handles all deletion commands that the user dictates.
...
\autoref{tab17} represents the command of the Invocation Layer.  This layer Handles all invocation commands that the user dictates.
