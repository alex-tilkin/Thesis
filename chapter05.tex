...
To test the grammar we provide two programs and their transcripts. The first example is an implementation of a linked list and the second is an example of the Command design pattern. \autoref{fig23}-\autoref{fig27} presents the program that implements Linked List.
\begin{figure}[H]
	\begin{lstlisting}
