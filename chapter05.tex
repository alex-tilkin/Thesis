...
To test the grammar we provide two programs and their transcripts. The first example is an implementation of a linked list and the second is an example of the Command design pattern. \autoref{fig23}-\autoref{fig29} presents the program that implements Linked List.
\begin{figure}[H]
	\begin{lstlisting}
...
WRITE ABOUT THE TRANSCRIPT.
\section{Implementation}
We choose Antlr as the tool for the implementation. The implementation of the \textit{Dictation Parser} is explained in details in \ref{section:BNF Parser}.