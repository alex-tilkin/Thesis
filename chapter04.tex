...
\begin{table}[H]
	...
	\end{tabular}
	\caption{This table presents operators and symbols that represent them in compact representation. The symbols are examples for how symbols may be presented. The user may modify to any representation that s/he wants. This idea is discussed in \chapref{chapter:Configuration of Representation}. Note: ; is used as a separator between operator symbols.}
	\label{tab12}
\end{table}
...
\begin{figure}[H]
	...
	\end{tabular}
	\caption{This is a more clear view of the methods in \autoref{fig59}. The methods are organized in a transparent table.}
	\label{fig60}
\end{figure}
