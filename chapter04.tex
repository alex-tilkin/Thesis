...
Instead of using long terms such as: Implements, and inherits. The programmer may change the text to a more compact representation, e.g., use the symbol ”:” from C++. It is Also possible to use text or icon.